...
export function mergeComponents(
  ...
  return {
    ...
    block: mergeDeeply(
      ...
      overrides,
      "block"
    ) as PortableTextSolidComponents["block"],
    list: mergeDeeply(
      parent,
      overrides,
      "list"
    ) as PortableTextSolidComponents["list"],
    listItem: mergeDeeply(
      parent,
      overrides,
      "listItem"
    ) as PortableTextSolidComponents["listItem"],
    marks: mergeDeeply(
      parent,
      overrides,
      "marks"
    ) as PortableTextSolidComponents["marks"],
    types: mergeDeeply(
      parent,
      overrides,
      "types"
    ) as PortableTextSolidComponents["types"],
    ...rest,
  };
}
